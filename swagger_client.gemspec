...
Gem::Specification.new do |s|
  s.name        = "antmedia_client"
  s.version     = AntmediaClient::VERSION
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["Swagger-Codegen"]
  s.email       = [""]
  s.homepage    = "https://github.com/swagger-api/swagger-codegen"
  s.summary     = "Ant Media Server REST API Reference Ruby Gem"
  ...
  # s.add_development_dependency 'autotest-fsevent', '~> 0.2', '>= 0.2.20'

...
# Unit tests for AntmediaClient::StorageClient
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'StorageClient' do
  before do
    # run before each test
    @instance = AntmediaClient::StorageClient.new
  end
  ...
  describe 'test an instance of StorageClient' do
    it 'should create an instance of StorageClient' do
      expect(@instance).to be_instance_of(AntmediaClient::StorageClient)
    end
  end

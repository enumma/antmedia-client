...
module AntmediaClient
  ...
  class Endpoint
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'endpointServiceId')
        self.endpoint_service_id = attributes[:'endpointServiceId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          rtmp_url == o.rtmp_url &&
          endpoint_service_id == o.endpoint_service_id
    end
    ...
    def hash
      [status, type, rtmp_url, endpoint_service_id].hash
    end

...
module AntmediaClient
  ...
  class TensorFlowObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'detectionTime')
        self.detection_time = attributes[:'detectionTime']
      end
      ...
      if attributes.has_key?(:'minX')
        self.min_x = attributes[:'minX']
      end

      if attributes.has_key?(:'minY')
        self.min_y = attributes[:'minY']
      end

      if attributes.has_key?(:'maxX')
        self.max_x = attributes[:'maxX']
      end

      if attributes.has_key?(:'maxY')
        self.max_y = attributes[:'maxY']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          detection_time == o.detection_time &&
          image_id == o.image_id &&
          min_x == o.min_x &&
          min_y == o.min_y &&
          max_x == o.max_x &&
    ...
    def hash
      [object_name, probability, detection_time, image_id, min_x, min_y, max_x, max_y].hash
    end

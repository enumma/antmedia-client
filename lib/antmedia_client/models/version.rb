...
module AntmediaClient
  ...
  class Version
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'versionName')
        self.version_name = attributes[:'versionName']
      end

      if attributes.has_key?(:'versionType')
        self.version_type = attributes[:'versionType']
      end

      if attributes.has_key?(:'buildNumber')
        self.build_number = attributes[:'buildNumber']
      end
    end
    ...
    def hash
      [version_name, version_type, build_number].hash
    end

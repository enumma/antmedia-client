...
module AntmediaClient
  ...
  class Result
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dataId')
        self.data_id = attributes[:'dataId']
      end

      if attributes.has_key?(:'errorId')
        self.error_id = attributes[:'errorId']
      end
    end
    ...
    def hash
      [success, message, data_id, error_id].hash
    end

...
module AntmediaClient
  ...
  class ConferenceRoom
    ...
    attr_accessor :room_stream_list

    # Conference Room Mode: legacy | mcu | multi-track
    attr_accessor :mode

    # the origin address of the node hosting the room
    ...
    def self.attribute_map
      {
        ...
        :'end_date' => :'endDate',
        :'room_stream_list' => :'roomStreamList',
        :'mode' => :'mode',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'roomStreamList')
        if (value = attributes[:'roomStreamList']).is_a?(Array)
          self.room_stream_list = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          end_date == o.end_date &&
          room_stream_list == o.room_stream_list &&
          mode == o.mode &&
    ...
    def hash
      [room_id, start_date, end_date, room_stream_list, mode, origin_adress].hash
    end

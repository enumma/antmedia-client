...
module AntmediaClient
  class IPersistenceStore
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'objectNames')
        if (value = attributes[:'objectNames']).is_a?(Array)
          self.object_names = value
        end
      end

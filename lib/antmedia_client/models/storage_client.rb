...
module AntmediaClient
  class StorageClient
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'storageClass')
        self.storage_class = attributes[:'storageClass']
      end
    end
    ...
    def hash
      [endpoint, access_key, secret_key, region, storage_name, permission, enabled, storage_class].hash
    end

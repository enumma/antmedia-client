...
module AntmediaClient
  class CloseableHttpClient
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'connectionManager')
        self.connection_manager = attributes[:'connectionManager']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          params == o.params &&
          connection_manager == o.connection_manager
    end
    ...
    def hash
      [params, connection_manager].hash
    end

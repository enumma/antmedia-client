...
module AntmediaClient
  class ConsoleDataStoreFactory
    ...
    def self.swagger_types
      {
        :'data_store' => :'AbstractConsoleDataStore',
        :'app_name' => :'String',
        :'db_name' => :'String',
        :'db_type' => :'String',
        :'db_host' => :'String',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dbName')
        self.db_name = attributes[:'dbName']
      end

      if attributes.has_key?(:'dbType')
        self.db_type = attributes[:'dbType']
      end

      if attributes.has_key?(:'dbHost')
        self.db_host = attributes[:'dbHost']
      end

      if attributes.has_key?(:'dbUser')
        self.db_user = attributes[:'dbUser']
      end

      if attributes.has_key?(:'dbPassword')
        self.db_password = attributes[:'dbPassword']
      end
    end
    ...
    def hash
      [data_store, app_name, db_name, db_type, db_host, db_user, db_password].hash
    end

...
module AntmediaClient
  # Stores the info for a WebRTC viewer
  class WebRTCViewerInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'viewerId')
        self.viewer_id = attributes[:'viewerId']
      end
      ...
      if attributes.has_key?(:'edgeAddress')
        self.edge_address = attributes[:'edgeAddress']
      end
    end
    ...
    def hash
      [viewer_id, stream_id, edge_address].hash
    end

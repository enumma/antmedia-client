...
module AntmediaClient
  class StreamAcceptFilter
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'maxFps')
        self.max_fps = attributes[:'maxFps']
      end
      ...
      if attributes.has_key?(:'maxBitrate')
        self.max_bitrate = attributes[:'maxBitrate']
      end
    end
    ...
    def hash
      [app_settings, max_fps, max_resolution, max_bitrate].hash
    end
